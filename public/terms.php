...
<? include '../assets/php/head.php'; ?>
    <section class="title_sect">
        <div class="wrap">
            <h1 class="row1"><span>Terms and conditions:</span><br> Rules, refund, and privacy</h1>
            <!--
            <div class="row2">
                Our Rules
            </div>
    ...
    <div class="wrap">
        <div class="row1">
            ...
            <ul>
                ...
                <li>
                    Please contact us using the form or email at <a href="mailto:contact@likewave.io">contact@likewave.io</a> if you have not received the service.
                </li>
            </ul>
            <div class="color_bg">
