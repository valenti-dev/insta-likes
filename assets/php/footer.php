<footer class="footer">
    <div class="wrap">
        <div class="row1">
            ...
            <div class="col col4">
                <div class="line2">Payment method</div>
                <div class="line4">
                    <div class="item"><img class="logo" alt="Payment for likes and followers" src="/img/footer/visa.svg"></div>
                    <div class="item"><img class="logo" alt="Payment for likes and followers" src="/img/footer/mastercard.svg"></div>
                </div>
            </div>
        </div>
        <div class="row2">
            <div class="left">
                <div class="line1">Copyright © 2022 Likewave.io All Rights Reserved.</div>
            </div>
            <div class="right">
                <div class="line1">
